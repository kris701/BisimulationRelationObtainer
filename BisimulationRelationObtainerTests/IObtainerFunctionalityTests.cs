...
namespace BisimulationRelationObtainerTests
{
    ...
    public class IObtainerFunctionalityTests
    {
        ...
        public void Can_SimpleNaive_GiveCorrectRelation(Process P, Process Q, string expected)
        {
            // ARRANGE
        ...
        public void Can_HopcroftAndKarp_GiveCorrectRelation(Process P, Process Q, string expected)
        {
            // ARRANGE
